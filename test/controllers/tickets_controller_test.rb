...
class TicketsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ticket" do
    assert_difference('Ticket.count') do
      post tickets_url, params: { ticket: { paid_from: @ticket.paid_from, paid_to: @ticket.paid_to, registration_number: @ticket.registration_number, space_id: @ticket.space_id, total_cost: @ticket.total_cost } }
    end
